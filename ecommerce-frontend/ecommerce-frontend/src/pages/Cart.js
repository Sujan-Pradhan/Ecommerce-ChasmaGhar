                            ...
                            <div className="row d-flex justify-content-between mt-5 mb-3">
                                ...
                                <div className="col-md-3">
                                    <div className="shadow p-2">
                                        <h5>Cart Summary</h5>
                                        <hr />
                                        <span><b>Units:</b> {cartItems.reduce((acc,item)=>(acc+Number(item.quantity)),0)} (Units)</span><br />
                                        <span><b>Total:</b> Rs.{cartItems.reduce((acc, item)=>(acc+item.quantity*item.price),0)}</span>
                                        <hr />
