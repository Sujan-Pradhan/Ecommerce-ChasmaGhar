...
const Shipping = () => {
 ...
 const submitHandler = (e)=>{
  e.preventDefault()
  dispatch(saveShippingInfo({shippingAddress1, shippingAddress2, city, postalCode, country, phone}))
  navigate('/confirm')
 }
  return (
   <>
   ...
   <div className='col-md-5 offset-md-3 p-3 my-4 shadow-lg'>
    <form>
     ...
     <div className='mb-3'>
      <label htmlFor='address1'>Shipping Address1</label>
      <input type='text' className='form-control' id='address1'
      onChange={(e)=>setShippingAddress1(e.target.value)} value={shippingAddress1} required />
     </div>
     <div className='mb-3'>
      <label htmlFor='address2'>Shipping Address2</label>
      <input type='text' className='form-control' id='address2'
      onChange={(e)=>setShippingAddress2(e.target.value)} value={shippingAddress2} required/>
     </div>
     <div className='mb-3'>
     ...
     <div className='mb-3'>
      ...
      <select required className='form-control' id='country'
